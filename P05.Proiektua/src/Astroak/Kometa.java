...
public class Kometa implements intAstro {
    ...
    public Kometa(String izena, double masa, String dataAktibitate, String konposizioa, Koordenatuak raKoordenatuak, Koordenatuak deKoordenatuak, String iruzkinak) {
        this.izena = izena;
        this.masa = masa;
